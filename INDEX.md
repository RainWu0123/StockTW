...
1. **AI 可解析**：`research/gooaye_digest.json`
2. **人讀判斷**：`research/摘要_股癌消化筆記_20260714.md`
3. 索引／編年：觀點庫、H1 全景、故事線

| 檔案 | 主題 |
|------|------|
| `gooaye_digest.json` | **機器可讀消化結果（schema v1）** |
| `摘要_股癌消化筆記_20260714.md` | **人讀消化：框架／立場／用法** |
