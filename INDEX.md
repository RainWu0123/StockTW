...
**股癌入口**：
- **消化後判斷（優先）**：`摘要_股癌消化筆記_20260714.md`
- 交易／現盤索引：`摘要_股癌2026觀點庫_20260714.md` + `摘要_股癌2026H1全景_20260714.md`（A/B/C）
- 故事／編年：`摘要_股癌故事線_2025Q4至2026H1_20260714.md`

| 檔案 | 主題 |
|------|------|
| `摘要_股癌消化筆記_20260714.md` | **真正消化：框架／因果／同意保留／個股用法** |
